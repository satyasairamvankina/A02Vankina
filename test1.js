...
QUnit.test('Testing total resistance myfunction with several sets of inputs', function (assert) {
   /* assert.equal(myFunction(2, 2, 4, 4), 6, 'Tested with 4 numbers gives total resistance');*/
    assert.throws(function() { test(null) }, 'Gives the total resistance');
});
